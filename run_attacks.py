    ...
    if (CIFAR_FGSM):
        try:
            ...
            AttackDispatcher(
                ...
                adversaryPath="Adversaries/CIFAR10/scaled_boxed/FGSM_train_data.npy",
                originalLabelPath="Adversaries/CIFAR10/scaled_boxed/Original_train_labels.npy",
                adversarialLabelPath="Adversaries/CIFAR10/scaled_boxed/FGSM_train_labels.npy",
    ...
    if (CIFAR_PGD):
        try:
            ...
            AttackDispatcher(
                ...
                targetPath="Datasets/CIFAR10/train_target.npy",
                modelPath="Models/CIFAR10/base_model.keras",
                adversaryPath="Adversaries/CIFAR10/scaled_boxed/PGD_train_data.npy",
                originalLabelPath="Adversaries/CIFAR10/scaled_boxed/Original_train_labels.npy",
                adversarialLabelPath="Adversaries/CIFAR10/scaled_boxed/PGD_train_labels.npy",
                lossObject=keras.losses.CategoricalCrossentropy(),
                stepcount=20,
                stepsize=stepsize,
                return_labels=True,
    ...
    if (CIFAR_RDSA):
        try:   
            ...
            AttackDispatcher(
                ...
                targetPath="Datasets/CIFAR10/train_target.npy",
                modelPath="Models/CIFAR10/base_model.keras",
                adversaryPath="Adversaries/CIFAR10/scaled_boxed/RDSA_train_data.npy",
                originalLabelPath="Adversaries/CIFAR10/scaled_boxed/Original_train_labels.npy",
                adversarialLabelPath="Adversaries/CIFAR10/scaled_boxed/RDSA_train_labels.npy",
                attempts=25,
    ...
    if (ImageNet_FGSM):
        try:
            ...
            AttackDispatcher(
                ...
                adversaryPath="Adversaries/ImageNet/scaled_boxed/FGSM_threshold_data.npy",
                originalLabelPath="Adversaries/ImageNet/scaled_boxed/Original_train_labels.npy",
                adversarialLabelPath="Adversaries/ImageNet/scaled_boxed/FGSM_threshold_labels.npy",
                lossObject=keras.losses.CategoricalCrossentropy(),
                epsilon=0.05,
                return_labels=True,
                n=1,
    ...
    if (ImageNet_PGD):
        try:
            ...
            AttackDispatcher(
                ...
                targetPath="Datasets/ImageNet/threshold_target.npy",
                modelPath="Models/ImageNet/base_model.keras",
                adversaryPath="Adversaries/ImageNet/scaled_boxed/PGD_threshold_data.npy",
                originalLabelPath="Adversaries/ImageNet/scaled_boxed/Original_train_labels.npy",
                adversarialLabelPath="Adversaries/ImageNet/scaled_boxed/PGD_threshold_labels.npy",
                lossObject=keras.losses.CategoricalCrossentropy(),
                stepcount=20,
                stepsize=stepsize,
                return_labels=True,
    ...
    if (ImageNet_RDSA):
        try:
            ...
            AttackDispatcher(
                ...
                targetPath="Datasets/ImageNet/threshold_target.npy",
                modelPath="Models/ImageNet/base_model.keras",
                adversaryPath="Adversaries/ImageNet/scaled_boxed/RDSA_threshold_data.npy",
                originalLabelPath="Adversaries/ImageNet/scaled_boxed/Original_train_labels.npy",
                adversarialLabelPath="Adversaries/ImageNet/scaled_boxed/RDSA_threshold_labels.npy",
                attempts=25,
    ...
    if (MNIST_FGSM):
        try:
            ...
            AttackDispatcher(
                ...
                adversaryPath="Adversaries/MNIST/scaled_boxed/FGSM_train_data.npy",
                originalLabelPath="Adversaries/MNIST/scaled_boxed/Original_train_labels.npy",
                adversarialLabelPath="Adversaries/MNIST/scaled_boxed/FGSM_train_labels.npy",
                lossObject=keras.losses.CategoricalCrossentropy(),
                epsilon=0.05,
                return_labels=True,
                n=1,
    ...
    if (MNIST_PGD):
        try:
            ...
            AttackDispatcher(
                ...
                targetPath="Datasets/MNIST/train_target.npy",
                modelPath="Models/MNIST/maxpool_model.keras",
                adversaryPath="Adversaries/MNIST/scaled_boxed/PGD_train_data.npy",
                originalLabelPath="Adversaries/MNIST/scaled_boxed/Original_train_labels.npy",
                adversarialLabelPath="Adversaries/MNIST/scaled_boxed/PGD_train_labels.npy",
                lossObject=keras.losses.CategoricalCrossentropy(),
                stepcount=20,
                stepsize=stepsize,
                return_labels=True,
    ...
    if (MNIST_RDSA):
        try:
            ...
            AttackDispatcher(
                ...
                targetPath="Datasets/MNIST/train_target.npy",
                modelPath="Models/MNIST/maxpool_model.keras",
                adversaryPath="Adversaries/MNIST/scaled_boxed/RDSA_train_data.npy",
                originalLabelPath="Adversaries/MNIST/scaled_boxed/Original_train_labels.npy",
                adversarialLabelPath="Adversaries/MNIST/scaled_boxed/RDSA_train_labels.npy",
                attempts=25,
                categoricalFeatureMaximum=100,
                binCount=100,
    ...
    if (TopoDNN_FGSM):
        try:
            ...
            AttackDispatcher(
                ...
                adversaryPath="Adversaries/TopoDNN/spreadlimited/FGSM_train_data.npy",
                originalLabelPath="Adversaries/TopoDNN/spreadlimited/Original_train_labels.npy",
                adversarialLabelPath="Adversaries/TopoDNN/spreadlimited/FGSM_train_labels.npy",
    ...
    if (TopoDNN_PGD):
        try:
            ...
            AttackDispatcher(
                ...
                targetPath="Datasets/TopoDNN/train_target.npy",
                modelPath="Models/TopoDNN/base_model.keras",
                adversaryPath="Adversaries/TopoDNN/spreadlimited/PGD_train_data.npy",
                originalLabelPath="Adversaries/TopoDNN/spreadlimited/Original_train_labels.npy",
                adversarialLabelPath="Adversaries/TopoDNN/spreadlimited/PGD_train_labels.npy",
                lossObject=keras.losses.BinaryCrossentropy(),
                stepcount=20,
                stepsize=stepsize,
                return_labels=True,
    ...
    if (TopoDNN_RDSA):
        try:
            ...
            AttackDispatcher(
                ...
                targetPath="Datasets/TopoDNN/train_target.npy",
                modelPath="Models/TopoDNN/base_model.keras",
                adversaryPath="Adversaries/TopoDNN/spreadlimited/RDSA_train_data.npy",
                originalLabelPath="Adversaries/TopoDNN/spreadlimited/Original_train_labels.npy",
                adversarialLabelPath="Adversaries/TopoDNN/spreadlimited/RDSA_train_labels.npy",
                attempts=25,
