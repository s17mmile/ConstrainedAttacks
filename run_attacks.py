    ...
    if (CIFAR_FGSM):
        try:
            ...
            AttackDispatcher(
                ...
                newLabelPath="Adversaries/CIFAR10/scaled_boxed/FGSM_train_labels.npy",
    ...
    if (CIFAR_PGD):
        try:
            ...
            AttackDispatcher(
                ...
                newLabelPath="Adversaries/CIFAR10/scaled_boxed/PGD_train_labels.npy",
                lossObject=keras.losses.CategoricalCrossentropy(),
                stepcount=20,
                stepsize=stepsize,
                # n=1,
    ...
    if (CIFAR_RDSA):
        try:   
            ...
            AttackDispatcher(
                ...
                newLabelPath="Adversaries/CIFAR10/scaled_boxed/RDSA_train_labels.npy",
                attempts=25,
    ...
    if (ImageNet_FGSM):
        try:
            ...
            AttackDispatcher(
                ...
                newLabelPath="Adversaries/ImageNet/scaled_boxed/FGSM_threshold_labels.npy",
                lossObject=keras.losses.CategoricalCrossentropy(),
                epsilon=0.05,
                # n=1,
                workercount=8,
    ...
    if (ImageNet_PGD):
        try:
            ...
            AttackDispatcher(
                ...
                newLabelPath="Adversaries/ImageNet/scaled_boxed/PGD_threshold_labels.npy",
                lossObject=keras.losses.CategoricalCrossentropy(),
                stepcount=20,
                stepsize=stepsize,
                # n=1,
    ...
    if (ImageNet_RDSA):
        try:
            ...
            AttackDispatcher(
                ...
                newLabelPath="Adversaries/ImageNet/scaled_boxed/RDSA_threshold_labels.npy",
                attempts=25,
    ...
    if (MNIST_FGSM):
        try:
            ...
            AttackDispatcher(
                ...
                newLabelPath="Adversaries/MNIST/scaled_boxed/FGSM_train_labels.npy",
                lossObject=keras.losses.CategoricalCrossentropy(),
                epsilon=0.05,
                # n=1,
                workercount=8,
    ...
    if (MNIST_PGD):
        try:
            ...
            AttackDispatcher(
                ...
                newLabelPath="Adversaries/MNIST/scaled_boxed/PGD_train_labels.npy",
                lossObject=keras.losses.CategoricalCrossentropy(),
                stepcount=20,
                stepsize=stepsize,
                # n=1,
    ...
    if (MNIST_RDSA):
        try:
            ...
            AttackDispatcher(
                ...
                newLabelPath="Adversaries/MNIST/scaled_boxed/RDSA_train_labels.npy",
                attempts=25,
                categoricalFeatureMaximum=100,
                binCount=100,
    ...
    if (TopoDNN_FGSM):
        try:
            ...
            AttackDispatcher(
                ...
                newLabelPath="Adversaries/TopoDNN/spreadlimited/FGSM_train_labels.npy",
    ...
    if (TopoDNN_PGD):
        try:
            ...
            AttackDispatcher(
                ...
                newLabelPath="Adversaries/TopoDNN/spreadlimited/PGD_train_labels.npy",
                lossObject=keras.losses.BinaryCrossentropy(),
                stepcount=20,
                stepsize=stepsize,
                # n=1,
    ...
    if (TopoDNN_RDSA):
        try:
            ...
            AttackDispatcher(
                ...
                targetPath="Datasets/TopoDNN/train_target.npy",
                modelPath="Models/TopoDNN/base_model.keras",
                adversaryPath="Adversaries/TopoDNN/spreadlimited/RDSA_train_data_10.npy",
                newLabelPath="Adversaries/TopoDNN/spreadlimited/RDSA_train_labels_10.npy",
                attempts=25,
